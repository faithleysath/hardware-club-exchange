...
- 详情页：展示闲置描述、图片、卖家信息和预约入口。
- 发布与编辑页：卖家管理自己的闲置信息。
- 我的页面：查看我的发布、我的预约、我的收藏。
- 管理台：审核成员、审核闲置、处理举报、查看审计日志。
...
- `admin`：具备成员权限，并可审核、下架、封禁、查看审计日志。
...
- 集成测试：覆盖发布、审核、预约、下架等关键业务链路。
- 端到端测试：覆盖登录、发布闲置、管理员审核、买家预约四条主路径。
